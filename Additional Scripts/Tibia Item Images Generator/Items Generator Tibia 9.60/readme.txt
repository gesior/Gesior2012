...
1. Put files [TIBIA CLIENT FILES] Tibia.dat, Tibia.spr and [OTS FILE] items.otb in folder 'data960'.
...
3. Open in web browser script: getsingle960.php with parameter id=100, example:
http://127.0.0.1/getsingle960.php?id=100
