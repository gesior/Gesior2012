...
function OpenNews(id) {
  ...
  document.getElementById(idButton).style.backgroundImage = "url(./layouts/tibiacom/images/general/minus.gif)";
}
...
function CloseNews(id) {
  ...
  document.getElementById(idButton).style.backgroundImage = "url(./layouts/tibiacom/images/general/plus.gif)";
}
