	...
	if(($action == '') or ($action == 'item') or ($action == 'container'))
	{
		...
		if((count($offer_list['item']) > 0) and ($action == 'item'))
		{
			...
			foreach($offer_list['item'] as $item)
			{
				...
				$main_content .= '<tr bgcolor="'.$bgcolor.'"><td align="center"><b>'.$item['points'].'</b></td><td align="center"><img src="images/items/'.$item['item_id'].'.gif"></td><td><b>'.htmlspecialchars($item['name']).'</b> ('.$item['points'].' points)<br />'.htmlspecialchars($item['description']).'</td><td align="center">';
				if(!$logged)
				{
		...
		if((count($offer_list['container']) > 0) and ($action == 'container'))
		{
			...
			{
				$main_content .= '<tr bgcolor="'.$bgcolor.'"><td align="center"><b>'.$container['points'].'</b></td><td align="center"><img src="images/items/'.$container['item_id'].'.gif"></td><td><b>'.htmlspecialchars($container['name']).'</b> ('.$container['points'].' points)<br />'.htmlspecialchars($container['description']).'</td><td align="center">';
				if(!$logged)
				{
					$main_content .= '<b>Login to buy</b>';
				}
